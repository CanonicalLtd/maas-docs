...
Add the public key to `/ubuntu/.ssh/authorized_keys` on the KVM host:
...
Still as user 'maas', test connecting to the KVM host with virsh (use
appropriate values for USER and KVM_HOST):
